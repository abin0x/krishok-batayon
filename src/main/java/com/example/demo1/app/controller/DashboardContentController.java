...
public class DashboardContentController {
    ...
    private static final Path USER_DATA_FILE = Path.of("src/main/resources/data/user_data.json");
    ...
    @FXML private Label lblProfileLocation;
    @FXML private Label lblProfileName;
    @FXML private Label lblProfilePhone;
    @FXML private Label lblProfileSoil;
    ...
    @FXML private Label lblProfileLocationDetail;
    @FXML private Label lblProfileSoilDetail;
    @FXML private Label lblProfileMobileDetail;
